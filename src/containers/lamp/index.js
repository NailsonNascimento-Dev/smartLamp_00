...
class Lamp extends Component {
  ...
  render() {
    ...
    //******** cria a instancia da lampada "chama a lampada/imagem" */
      ...
      <View style={styles.container} accessibilityLabel="LampView">
        ...
        <View style={styles.box}>
          <Image
            ...
            style={[
              styles.lightShadow,
              //ponto que altera a opacidade da lâmpada "Botão on"
              { opacity: power ? this.formatOpacity(currentBright) : 0.2 },
            ]}
          />

          {/* *************** campo de texto para debug ***************** */}
          <View>
            <TYText>brilho = 111 { lampOffImage } </TYText>
            <TYText> cor = { currentBright } </TYText>
            <TYText> cor = { currentBright } </TYText>
